...
|---|---|---|---|---|---|
| #140092 | CVE-2026-39821 | k8s.io/kubernetes — golang.org/x/net@v0.49.0 | fixed | `—` | CVE-2026-39821 affects golang.org/x/net <v0.55.0 (x/net/idna); the scanner flagged kubectl 1.36.2 (shipping v0.49.0). Fixed upstream: Kubernetes now vendors golang.org/x/net >=v0.55.0 (currently v0.55.1-0.20260602…), so the vulnerable version is no longer present. Related bumps: [#138561](https://github.com/kubernetes/kubernetes/pull/138561), [#139420](https://github.com/kubernetes/kubernetes/pull/139420). See [#140092](https://github.com/kubernetes/kubernetes/issues/140092). |
